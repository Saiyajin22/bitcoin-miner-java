...
public class TestHashComparison {
    ...
    @Test
    public void testHexadecimalStringComparisonWithPrefix() {
        final String s1 = "0x00F";
        final String s2 = "0x0AF";

        final boolean result = BlockUtil.compareHexadecimalStrings(s1, s2, "0x");
        assertTrue(result);
    }

    @Test
    public void testHexadecimalStringComparisonWithoutPrefix() {
        final String s1 = "00F";
        final String s2 = "0AF";
